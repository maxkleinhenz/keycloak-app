...
const buttonClass = cva("transform active:scale-95 transition-colors duration-300 flex items-center gap-1", {
  variants: {
    intent: {
      primary: "bg-juso-rot text-white hover:ring-juso-rot hover:ring-1 hover:ring-offset-1",
      secondary: "",
      tertiary: "hover:ring-juso-rot hover:ring-1 hover:ring-offset-1 border-none",
...
<template>
  <component :is="component" :class="twMerge(buttonClass({ intent, shape, size }))" v-bind="$attrs">
    <slot />
  </component>
</template>